...
def inicio():
    ...
    try:
        ...
        player = Personagem(player_sprite, menu.atributos["ataque"], menu.atributos["defesa"], 
                          menu.atributos["vida"], menu.atributos["stamina"], menu.atributos["velocidade"])
    except Exception as e:
    ...
    while running:
        ...
        if boss.HP > 0:
            ...
            running = False
            from mapa_main.main_mapa import inicio as mapa_principal
            mapa_principal()
