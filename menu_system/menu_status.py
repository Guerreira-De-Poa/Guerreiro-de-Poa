...
class Menu():
    def __init__(self, valor_ataque, valor_defesa, valor_vida, valor_stamina, valor_velocidade, atr_ataque, atr_defesa, atr_vida, atr_stamina, atr_velocidade):  
        ...
        self.botao_mais = pygame.image.load('menu_system/nivel_1/SpriteSheet_mais.png')
        self.botao_menos = pygame.image.load('menu_system/nivel_1/Spritesheet_menos.png')
